...
public class TinyDB {
    ...
    public ArrayList<ParseObject> getListParse(String key,Class<?> mClass ){
        Gson gson = new Gson();
        ...
        for (String jObjString : objStrings) {
            ParseObject value = (ParseObject) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListParse(String key , ArrayList<ParseObject> parseObjectArrayList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : parseObjectArrayList){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
